...
<section id="timeline">
  ...
  <svg id="svg" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 600 500">
    ...
    <circle class="circle circle--1" r="15px" cx="300" cy="100"></circle>
    ...
    <circle class=" circle circle--2" r="15px" cx="300" cy="200"></circle>
    ...
    <circle class="circle circle--3" r="15px" cx="300" cy="300"></circle>
    ...
    <circle class="circle circle--4" r="15px" cx="300" cy="400"></circle>
